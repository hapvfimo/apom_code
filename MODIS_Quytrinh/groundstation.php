...
$create_pm_cmd = "Rscript /var/www/html/MODIS_Quytrinh/AodToPm.R ";
...
echo $create_pm_cmd . $type . " "  . $fileResample[0] . " " . $fileResample[1] . " " . $sourceid;



$out = shell_exec($create_pm_cmd . $type . " "  . $fileResample[0] . " " . $fileResample[1] . " " . $sourceid);
echo $create_pm_cmd . $type . " "  . $fileResample[0] . " " . $fileResample[1] . " " . $sourceid;
echo '\n'.$out;
